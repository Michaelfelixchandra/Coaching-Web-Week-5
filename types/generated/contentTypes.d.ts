...
export interface ApiInboxInbox extends Schema.CollectionType {
  ...
  attributes: {
    Inbox: Attribute.Enumeration<['Annoucement', 'Comment']>;
    User: Attribute.String;
    Description: Attribute.Text;
    song: Attribute.Relation<'api::inbox.inbox', 'manyToOne', 'api::song.song'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiOtherInformationOtherInformation
  extends Schema.CollectionType {
  collectionName: 'other_informations';
  info: {
    singularName: 'other-information';
    pluralName: 'other-informations';
    displayName: 'otherInformation';
    description: '';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    songs: Attribute.Relation<
      'api::other-information.other-information',
      'manyToMany',
      'api::song.song'
    >;
...
export interface ApiSongSong extends Schema.CollectionType {
  ...
  attributes: {
    ...
    inboxes: Attribute.Relation<
      ...
      'api::inbox.inbox'
    >;
    other_informations: Attribute.Relation<
      'api::song.song',
      'manyToMany',
      'api::other-information.other-information'
    >;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::other-information.other-information': ApiOtherInformationOtherInformation;
